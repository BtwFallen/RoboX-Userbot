...
if __name__ == "__main__":
    ...
    if install_type == "1":
        restart = "pm2 restart RoboX"
    elif install_type == "2":
        restart = "sudo systemctl restart RoboX"
    else:
        restart = "cd RoboX-Userbot/ && python3 main.py"

    app.start()
    try:
        app.send_message(
            "me",
            f"<b>[{datetime.datetime.now()}] RoboX-Userbot Has Been Deployed! \n"
            "Channel: @Life_Codes\nThanks For Choosing Titan's RoboX\n"\
