...
if __name__ == "__main__":
    ...
    try:
        ...
        if str(e) == "database is locked" and os.name == "posix":
            ...
            subprocess.run(["fuser", "-k", "RoboXUser.session"])
            restart()
        raise
    except (errors.NotAcceptable, errors.Unauthorized) as e:
        logging.error(
            f"{e.__class__.__name__}: {e}\n"
            f"Moving session file to RoboXUser.session-old..."
        )
        os.rename("./RoboXUser.session", "./RoboXUser.session-old")
        restart()
    ...
    logging.info("RoboX-Userbot started!")
    logging.info("==========================================")
    logging.info("RoboX-Userbot===Ayush")
